                  ...
                  child: Container(
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage('assets/images/banHome.png')),
                    ),
                  ),
                ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          icon: SvgPicture.asset(("assets/icons/notifIcon.svg"),
                              color: Colors.white, semanticsLabel: 'Label'),
                          onPressed: () {},
                        ),
                        IconButton(
                          icon: SvgPicture.asset(("assets/icons/cartIcon.svg"),
                              color: Colors.white, semanticsLabel: 'Label'),
                          onPressed: () {},
                        ),
                      ],
                ...
                children: [
                  ...
                  SizedBox(
                    child: Text(
                      "Lihat Semua",
                      textAlign: TextAlign.left,
                      style: TextStyle(fontSize: 12, color: Color(0xff006400)),
                    ),
                  ),
                ],
              ),
